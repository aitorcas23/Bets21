...
public class DeleteEventGUI extends JFrame {
	...
	private final JButton btnNewButton = new JButton("Remove"); //$NON-NLS-1$ //$NON-NLS-2$
...
//					jCalendar1.setCalendar(calendarAct);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					facade.deleteEventByNumber((Integer)tableEvents.getValueAt(tableEvents.getSelectedRow(),0));
					tableModelEvents.removeRow(tableEvents.getSelectedRow());
		...
		lblNewLabelMessage.setBounds(274, 340, 130, 14);
