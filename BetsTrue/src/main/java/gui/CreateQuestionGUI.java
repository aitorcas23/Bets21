...
public class CreateQuestionGUI extends JFrame {
	...
	private void jbInit(Vector<domain.Event> v) throws Exception {
		...
		jLabelMinBet.setBounds(new Rectangle(25, 268, 75, 20));
		jTextFieldPrice.setBounds(new Rectangle(101, 268, 60, 20));

		jCalendar.setBounds(new Rectangle(40, 50, 225, 150));
		scrollPaneEvents.setBounds(new Rectangle(25, 44, 346, 116));

		jButtonCreate.setBounds(new Rectangle(269, 263, 130, 30));
		...
		jButtonClose.setBounds(new Rectangle(424, 263, 130, 30));
		...
		jLabelError.setBounds(new Rectangle(171, 268, 86, 20));
