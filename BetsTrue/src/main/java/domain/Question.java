...
public class Question implements Serializable {
	...
	public Question(String query, float betMinimum,  Event event, double v1, String aswer1, double v2, String aswer) {
		super();
		this.question = query;
		this.betMinimum=betMinimum;
		this.event = event;
	...
	public void addQuote(double value, String feeName) {
		quotes.add(new Quote(value, feeName, this));
	}
